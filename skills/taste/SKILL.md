...
后续工作不能反向惩罚开创性论文。若后续工作是在该论文框架上改进、组合、工程化或扩展，这首先说明原论文有影响力，而不是说明原论文方法价值下降。后续工作只能影响“今天是否还值得直接复现”，不能降低原论文的历史方法价值。只有当后续工作证明原论文核心 claim 本身是错的，才可以反向降级。
...
* 它是不是已有方法换壳；
* 它有没有漏掉关键前作；
* 它有没有被后续工作快速超越；若后续工作是在原框架上改进，只能降低“今天直接复现”的必要性，不能降低原论文的历史方法价值；只有核心 claim 被证伪时才可反向降级；
* 它是不是只在作者自己设定里强；
